...
// I'll provide it"); until `video` is set the frame shows three real
// keyframes off the board instead (landing-media.ts), never a mock-up of
// the product. Put the mp4 on R2 and point `video` at it; `poster` is the
